            ...
            if each_val == 'True':
                while whileloop == 1:
                    try:
                        ...
                        print Fore.GREEN + "-------------------------------------------------------------------------------------------"
                        print Back.WHITE + Style.DIM + Fore.CYAN  + final[0] + Fore.GREEN + final[1] + Style.NORMAL + Fore.MAGENTA + Back.WHITE + final[2] + Fore.RED + Back.WHITE + final[3] + Fore.BLUE + Back.WHITE +" inserted into database" + Style.RESET_ALL
                        time.sleep(1)
                        whileloop = 0
